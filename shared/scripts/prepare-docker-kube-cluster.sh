...
source "/home/asw-sfingegram/shared/scripts/common.sh"
...
cp ${ASW_RESOURCES}/docker.service.d-kube-cluster/hosts.conf /etc/systemd/system/docker.service.d/hosts.conf
...
mkdir -p /etc/docker
cp ${ASW_RESOURCES}/etc.docker-kube-cluster/daemon.json /etc/docker/daemon.json
