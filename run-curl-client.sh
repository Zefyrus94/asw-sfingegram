...
echo "# l'enigma 1" 
echo $(curl -s sfinge:31080/enigmi/enigmi/1)
echo 

echo "# la soluzione dell'enigma 1" 
echo $(curl -s sfinge:31080/enigmi/enigmi/1/soluzione)
echo 

echo "# tutti gli enigmi dell'autore Il Valletto" 
echo $(curl -s sfinge:31080/enigmi/cercaenigmi/autore/Il%20Valletto)
echo 

echo "# tutti gli enigmi di tipo Indovinello" 
echo $(curl -s sfinge:31080/enigmi/cercaenigmi/tipo/Indovinello)
echo 

echo "# tutti gli enigmi di tipo Cambio" 
echo $(curl -s sfinge:31080/enigmi/cercaenigmi/tipo/Cambio)
echo 
...
echo $(curl -s sfinge:31080/connessioni/connessioniconautori/Alice)
echo 
...
echo $(curl -s sfinge:31080/connessioni/connessionicontipi/Alice)
echo 

echo "# gli enigmi seguiti da Alice" 
echo $(curl -s sfinge:31080/enigmi-seguiti/enigmiseguiti/Alice)
echo 

echo "# gli enigmi seguiti da Barbara" 
echo $(curl -s sfinge:31080/enigmi-seguiti/enigmiseguiti/Barbara)
echo 

echo "# gli enigmi seguiti da Carlo" 
echo $(curl -s sfinge:31080/enigmi-seguiti/enigmiseguiti/Carlo)
echo 
