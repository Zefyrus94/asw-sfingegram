...
curl -X POST "sfingegram:31080/connessioni/connessioniconautori" -H "accept: */*" -H "Content-Type: application/json" \
...
curl -X POST "sfingegram:31080/connessioni/connessionicontipi" -H "accept: */*" -H "Content-Type: application/json" \
