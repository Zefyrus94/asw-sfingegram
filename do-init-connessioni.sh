...
curl -X POST "sfinge:31080/connessioni/connessioniconautori" -H "accept: */*" -H "Content-Type: application/json" \
...
curl -X POST "sfinge:31080/connessioni/connessionicontipi" -H "accept: */*" -H "Content-Type: application/json" \
